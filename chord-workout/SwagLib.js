...
function SetupAuxNodes(stream) {
    ...
    function recording() {
        ...
        // let binarray t= TopBinsRaw(segment, segment[winnerBin]);
...
function notesToChordGuess(playedNotes, allChordStructures) {
    ...
    for (let i = 0; i < myIntervals.length; i++) {
        ...
        if (chord) {
            ...
            return chromaticC3[basenote] + " " + chord; //if it's the 2nd interval that matches it was also the second note that is the winner
        }
    }
    return "";
}
